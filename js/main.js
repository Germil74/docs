...
/***/ "./src/js/components/mobailMenu.js":
/*!*****************************************!*\
  !*** ./src/js/components/mobailMenu.js ***!
  \*****************************************/
...
var mobileMenu = function mobileMenu(triggerSelector, triggerClose, selectorParent, classBtnClose, classOverlay) {
  var trigger = document.querySelector(triggerSelector),
      wrapperMenu = document.querySelector(trigger.dataset.target),
      overlay = document.querySelector("".concat(trigger.dataset.target, "-overlay")),
      close = wrapperMenu.querySelector(triggerClose),
      parent = wrapperMenu.querySelectorAll(selectorParent);
  var level = 1;
  ...
  function closed(classBtnClose, classOverlay) {
    document.addEventListener('click', function (e) {
      if (e.target.classList && e.target.classList.contains(classBtnClose) || e.target.classList && e.target.classList.contains(classOverlay)) {
        level = 1;
        ...
        wrapperMenu.querySelector('.wrap').style.transform = 'none';
        document.querySelector('body').style.overflow = '';
      }
    });
  }
  /*    close.addEventListener('click', () => {
          if(wrapperMenu.classList.contains('show')) {
              wrapperMenu.classList.remove('show')
              overlay.style.display = 'none'
          }
      })*/
  ...
  document.addEventListener('click', function (e) {
    if (e.target.classList && e.target.nodeName === "SPAN" && e.target.classList.contains('arrow') || e.target.classList && e.target.nodeName === "I" && e.target.classList.contains('alb-svg')) {
      e.preventDefault();

      var _parent = e.target.closest('li.parent');

      var wrap = _parent.closest('.wrap');

      _parent.classList.add('expanded');

      wrap.style.transform = "translateX(-".concat(level * 100, "%)");
      level++;
    } else if (e.target.classList && e.target.nodeName === "I" && e.target.classList.contains('back_link') || e.target.classList && e.target.nodeName === "A" && e.target.classList.contains('back_link')) {
      e.preventDefault();
      level--;
      e.target.closest('li.parent').classList.remove('expanded');
      e.target.closest('.wrap').style.transform = "translateX(-".concat((level - 1) * 100, "%)");
    }
  });
  closed(classBtnClose, classOverlay);
};
...
/***/ "./src/js/components/searchAccordion.js":
/*!**********************************************!*\
  !*** ./src/js/components/searchAccordion.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var searchAccordion = function searchAccordion(selectorTrigger, selectorBlock) {
  var trigger = document.querySelector(selectorTrigger);
...
/* harmony default export */ __webpack_exports__["default"] = (searchAccordion);
...
/* harmony import */ var core_js_modules_es_array_some__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! core-js/modules/es.array.some */ "./node_modules/core-js/modules/es.array.some.js");
/* harmony import */ var core_js_modules_es_array_some__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_some__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! core-js/modules/es.number.constructor */ "./node_modules/core-js/modules/es.number.constructor.js");
/* harmony import */ var core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_number_constructor__WEBPACK_IMPORTED_MODULE_16__);
...
/* harmony import */ var core_js_modules_es_parse_float__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! core-js/modules/es.parse-float */ "./node_modules/core-js/modules/es.parse-float.js");
/* harmony import */ var core_js_modules_es_parse_float__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_parse_float__WEBPACK_IMPORTED_MODULE_21__);
...
/* harmony import */ var core_js_modules_es_string_fixed__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! core-js/modules/es.string.fixed */ "./node_modules/core-js/modules/es.string.fixed.js");
/* harmony import */ var core_js_modules_es_string_fixed__WEBPACK_IMPORTED_MODULE_28___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_fixed__WEBPACK_IMPORTED_MODULE_28__);
  ...
  function z(t, v, o) {
    ...
    function q(t) {
      var e,
          ...
          o,
          s,
          a = 100 * (t - (e = l, r = v.ort, n = e.getBoundingClientRect(), i = e.ownerDocument, o = i.documentElement, s = gt(i), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (s.x = 0), r ? n.top + s.y - o.clientTop : n.left + s.x - o.clientLeft)) / T();
    ...
    return ht(e = h, v.cssClasses.target), 0 === v.dir ? ht(e, v.cssClasses.ltr) : ht(e, v.cssClasses.rtl), 0 === v.ort ? ht(e, v.cssClasses.horizontal) : ht(e, v.cssClasses.vertical), ht(e, "rtl" === getComputedStyle(e).direction ? v.cssClasses.textDirectionRtl : v.cssClasses.textDirectionLtr), l = k(e, v.cssClasses.base), function (t, e) {
...
/* harmony import */ var _pug_components_rangeSlider_rangeSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../pug/components/rangeSlider/rangeSlider */ "./src/pug/components/rangeSlider/rangeSlider.js");
/* harmony import */ var _pug_components_ui_form_ui_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../pug/components/ui-form/ui-form */ "./src/pug/components/ui-form/ui-form.js");
/* harmony import */ var _components_mobailMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/mobailMenu */ "./src/js/components/mobailMenu.js");
/* harmony import */ var _components_searchAccordion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/searchAccordion */ "./src/js/components/searchAccordion.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_components_mobailMenu__WEBPACK_IMPORTED_MODULE_3__["default"])('.nav-toggler', '.mobile-close', '.parent', 'mobile-close', 'mobilemenu-overlay');
  Object(_components_searchAccordion__WEBPACK_IMPORTED_MODULE_4__["default"])('.search-btn', '.mobile-search-row');
  svg4everybody__WEBPACK_IMPORTED_MODULE_0___default()(); //  alert('negk.')
});

/***/ }),

/***/ "./src/pug/components/rangeSlider/rangeSlider.js":
/*!*******************************************************!*\
  !*** ./src/pug/components/rangeSlider/rangeSlider.js ***!
  \*******************************************************/
/*! no exports provided */
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _js_libs_nouislider_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../js/libs/nouislider.min */ "./src/js/libs/nouislider.min.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  input0.value = slider.noUiSlider.get()[0];
  input1.value = slider.noUiSlider.get()[1];
  ...
  inputs.forEach(function (inp, idx) {
    inp.addEventListener('input', function (e) {
      if (idx === 0) {
        slider.noUiSlider.set([+inp.value, null]);
      } else {
        slider.noUiSlider.set([null, +inp.value]);
      }
    });
  }); // noUiSlider.create(slider, {
  //     start: [20, 80],
...
/***/ "./src/pug/components/ui-form/ui-form.js":
/*!***********************************************!*\
  !*** ./src/pug/components/ui-form/ui-form.js ***!
  \***********************************************/
/*! no exports provided */
...
$(function () {
  $('.lincUp').on('click', function (e) {
    if ($(e.target).prev().hasClass('minWindow')) {
      $(e.target).text('Свернуть').prev().removeClass('minWindow').addClass('bigWindow');
      $(".bigWindow").niceScroll({
        cursorcolor: 'rgba(178,183,187,0.65)',
        cursorminheight: 23
      });
      $(e.target).closest('.box').find(".search-input").show();
    } else {
      $(e.target).text('Посмотреть всё').prev().removeClass('bigWindow').addClass('minWindow');
      $(e.target).closest('.box').find(".search-input").hide();
      $('.minWindow').getNiceScroll().remove();
      $('.minWindow').attr('style', '');
    }
  });
  $('.arrow_down').on('click', function (e) {
    console.log($(e.target).parent().next().css('display'));
